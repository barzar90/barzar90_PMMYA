(function ($, window, document, undefined) {
	...
	$.extend(Plugin.prototype, {
        ...
        {
            var template;
           // var alertMessage = '<%= HttpContext.GetGlobalResourceObject("Common", "CityMumbai") %>';
			var element = $(this.element);
            if (obj) {
                var cityname = "";
                if (obj.name == "Mumbai")
                ...
                else if (obj.name == "Aurangabad")
                {
                    cityname = CityName[1];
                }
                else if (obj.name == "Nagpur") {
                    cityname = CityName[2];
                }
                else if (obj.name == "Mecca") {
                    cityname = CityName[3];
                }
                else if (obj.name == "Medina") {
                    cityname = CityName[4];
                }
				...
				<img class="weather__checkbox">
				 <label class="weather__name-cityfont">${cityname}</label><br>
