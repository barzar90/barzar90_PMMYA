<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Videoplaycontrol2.ascx.cs" Inherits="PMMYA.Controls.WebSiteControls.Videoplaycontrol2" %>
 
   <%-- <h2><asp:Label ID="lblSuccessStories" runat="server" Text=""></asp:Label></h2>--%>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="col-md-8"><h4 class="modal-title modal-title-name">Success Stories</h4></div>
                                    </div>
